...
10 मिनट में AI चैट एजेंट बनाएं और लॉन्च करें। बहुभाषी समर्थन। लाइव एजेंट ट्रांसफर। वेबचैट, एसएमएस, Line, CRM, Shopify, कैलेंडर, Twilio, ZenDesk और फोन कॉल के साथ एकीकृत करें। अधिक जानकारी के लिए हमें [seachat@seasalt.ai](mailto:seameet@seasalt.ai) पर ईमेल करें या [एक डेमो बुक करें](https://meetings.hubspot.com/seasalt-ai/seasalt-meeting)।`;export{n as default};
