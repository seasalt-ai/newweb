...
10 मिनट में AI चैट एजेंट बनाएं और लॉन्च करें। बहुभाषी समर्थन। तत्काल एजेंट स्थानांतरण। वेब चैट, एसएमएस, Line, CRM, Shopify, कैलेंडर, Twilio, ZenDesk और फोन के साथ एकीकरण। अधिक जानकारी के लिए [seachat@seasalt.ai](mailto:seameet@seasalt.ai) को ईमेल करें या [डेमो बुक करें](https://meetings.hubspot.com/seasalt-ai/seasalt-meeting)। `;export{i as default};
