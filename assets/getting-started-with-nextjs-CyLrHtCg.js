...
*هل أنت مستعد لبناء مشروعك التالي؟ [اتصل بنا](/#demo) لمعرفة كيف يمكن لـ Seasalt.ai مساعدتك في دمج ميزات الاتصال القوية في تطبيق Next.js الخاص بك.*`;export{n as default};
