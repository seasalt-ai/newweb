...
image:
  ...
  alt: 分散型コンタクトセンターでコンタクトセンターのフットプリントを拡大する
tags:
- SeaX
lang: ja
draft: false
...
SeaXクラウドコンタクトセンターが、分散型コンタクトセンターを1つのプラットフォームでどのようにサポートしているかについてお読みいただきありがとうございます。次回のブログ記事にご期待ください。社内のテキスト読み上げおよび音声認識技術と、それらがコンタクトセンターをどのように強化できるかについて詳しく説明します。すぐに詳細を知りたい場合は、当社の「[デモを予約](https://calendar.app.google/FLjCxzbYLqG6CkNs9)」フォームにご記入いただき、SeaXプラットフォームをいち早く体験してください。
