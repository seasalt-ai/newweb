...
description: Dalam blog ini kami akan membahas temuan kami tentang bagaimana pengguna
  Discord nyata menggunakan layanan SeaVoice setelah meninjau data ucapan-ke-teks
  otentik selama beberapa minggu.
publishDate: '2023-01-23'
author: Kim Dodds
image:
  url: /images/blog/30-stt-case-study/discord-stt-bot-case-study.jpg
  alt: 'Ucapan-ke-Teks di Discord: Studi Kasus Bot Discord STT'
tags:
- SeaVoice
- Discord
lang: id
