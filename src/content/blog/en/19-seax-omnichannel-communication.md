...
description: In this blog, we highlight one of SeaX's omnichannel communications that
  allows user messages from any channel to be displayed on the SeaX platform.
publishDate: '2022-07-15'
updatedDate: '2024-12-19'
author: Kim Dodds
image:
  url: /images/blog/19-seax-omnichannel-communication/0-thumbnail.png
  alt: Bring Customers from Any Channel to One Place with SeaX Omnichannel Communication
tags:
- SeaX
lang: en
draft: false
