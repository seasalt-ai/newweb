...
description: Neste blog, discutiremos nossas descobertas sobre como os usuários reais
  do Discord estão usando os serviços SeaVoice após revisar várias semanas de dados
  brutos de fala para texto.
