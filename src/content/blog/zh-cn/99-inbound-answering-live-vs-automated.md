...
image:
  ...
  alt: 真人接线员与自动化应答服务：小型企业的实用建议 (4/5)
tags:
- 自动应答服务
- 小型企业入站呼叫
- SeaChat
...
3. [自动化电话应答系统（交互式语音应答 IVR 与语音 AI Agent）](https://seasalt.ai/blog/98-inbound-answering-automated-system/)：什么是自动化应答服务？您应该使用交互式语音应答 (IVR) 还是语音 AI Agent？
...
Retell AI 是一款强大的语音 AI 解决方案，旨在通过先进的 AI 技术简化呼叫操作，通过智能语音Agent自动化客户交互来提高效率。
...
通过 SeaChat，企业可以设置 AI Agent来接听电话。AI 处理日常任务，但如果需要，呼叫者可以转接给真人Agent。这种混合方法确保不会错过任何客户查询，同时仍然提供人际互动的个人接触。这种方法允许用户将路由和预约安排的任务委托给 AI Agent，并让真人接线员在电话线上接听电话，同时节省两项任务的成本。
...
## 案例研究：使用真人接线员或语音 AI Agent的餐厅

伊利诺伊州的 Lil Beaver Brewery 使用 Slang.ai 接听来电。它回答有关菜单、行车路线的问题，并转接给真人Agent。当客户来电时，友好的 AI 语音伴随着强劲的节拍和音乐，与啤酒厂的氛围相符。根据 Slang AI 的说法，餐厅可以自定义其数字语音和背景音景。餐厅还将拥有来电者的实时分析，平均每月节省 200 小时。客户满意度在 80% 以上。

Slang AI 的基本计划每月 199 美元起，高级计划每月最高 599 美元。

华盛顿的 STK Steakhouse 则使用集中式真人接线员服务。这是因为整个餐厅集团拥有多家分店，他们有真人Agent接听所有餐厅的电话。当客户来电时，真人Agent（可能位于纽约）会回答常见问题。

两种服务的真实体验

以下是体验过两种不同服务的用户的体验：

`我曾经问过餐厅是否提供自行车架来停放我没有锁的自行车。真人Agent不知道答案，然后说“请稍等片刻，让我和餐厅谈谈”。我就是这样发现Agent不在现场，可能是在远程。`
`然后Agent让我等了几分钟，然后带着答案回来了。是的，他们提供自行车存放处！`

`当我亲自（带着我的自行车）去餐厅时，接待员确实说他们使用远程Agent来处理所有来电。有时他们仍然会接到Agent的内部电话以进行澄清。`
...
对于小型企业来说，选择取决于具体需求、呼叫量和预算。对于许多企业来说，采用混合方法，即 AI 处理日常任务，而真人Agent处理复杂查询，可能是最有效和最经济实惠的选择。
...
- [自动化电话应答系统（交互式语音应答 IVR 与语音 AI Agent）](https://seasalt.ai/blog/98-inbound-answering-automated-system/)：什么是自动化应答服务？您应该使用机器人 IVR 还是语音 AI Agent？
