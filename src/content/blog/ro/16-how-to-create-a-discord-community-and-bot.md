...
description: În acest blog, vom parcurge crearea unui server pentru marca dvs. și
  conectarea unui bot, care poate automatiza moderarea, raportarea erorilor, anunțurile
  etc.
...
image:
  ...
  alt: 'Discord (2/3): Cum să creați o comunitate și un bot Discord pentru marca dvs.'
tags:
- SeaX
- Discord
lang: ro
