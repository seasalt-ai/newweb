---
title: AI 驅動的聯絡中心自動化：虛擬Agent與 CRM 的協作
...
image:
  ...
  alt: AI 驅動的聯絡中心自動化：虛擬Agent與 CRM 的協作
tags:
- HubSpot
- SeaX
lang: zh-tw
...
許多企業尚未善用這些平台整合所帶來的強大自動化。AI 驅動的虛擬Agent可簡化您的工作流程，並充分利用 HubSpot 的資料。

### 賦能您的虛擬Agent

SeaX 支援全通路，讓您能在單一介面與客戶跨多平台互動。連接 Twilio 平台的虛擬Agent可跨渠道聯絡客戶，全天候提供基礎支援。這些虛擬Agent負責例行任務與詢問，讓真人客服專注於更複雜的來電與工作。目前 SeaX 支援以下渠道：
...
整合 HubSpot 後，您的虛擬Agent可存取與真人客服相同的客戶資訊。隨著您在 HubSpot 記錄客戶資料，虛擬Agent對客戶的了解也會即時成長。
...
SeaX 的全通路支援可自動化發送 SMS、語音通話、Facebook Messenger、WhatsApp 等訊息。結合 HubSpot Webhooks API，可追蹤 HubSpot 物件變化，您只需點擊按鈕或移動支援票據，即可在任一渠道發送訊息給客戶。此外，虛擬Agent可處理客戶回覆，真人客服只需啟動對話。
...
SeaX 與 HubSpot 整合後，您可在聯絡中心介面直接存取客戶資料，也讓自動化與虛擬Agent能互動並擴充資料庫。

當您在 SeaX 結束與客戶的對話後，自動化可直接將互動記錄新增至 HubSpot 客戶聯絡人，真人客服無需花時間撰寫紀錄。虛擬Agent也能新增互動紀錄，並根據對話更新客戶聯絡資訊或預約時間。
