...
Cảm ơn bạn đã quan tâm đến dự án Bot Discord và Trí tuệ giọng nói của chúng tôi! Bạn có thể tìm hiểu thêm về sản phẩm STT của chúng tôi trên [Trang chủ Chuyển giọng nói thành văn bản](https://suite.seasalt.ai/tts) của chúng tôi. Để được demo trực tiếp một trong các sản phẩm Trí tuệ giọng nói của chúng tôi, hãy điền vào [Biểu mẫu Đặt lịch demo](https://calendar.app.google/GcdRQv1DVoiDaoCT6).
