---
title: 'SeaVoice STT/TTS Discord Bot: Đầu tiên cung cấp bản ghi âm giọng nói có thể
  tải xuống với bản chép lời AI'
description: Với bản phát hành mới nhất, SeaVoice Discord Bot là bot đầu tiên trên
  nền tảng này cung cấp bản ghi âm kênh thoại có thể tải xuống với bản chép lời do
  AI tạo ra.
...
image:
  ...
  alt: 'SeaVoice STT/TTS Discord Bot: Đầu tiên cung cấp bản ghi âm giọng nói có thể
    tải xuống với bản chép lời AI'
tags:
- SeaVoice
- Discord
