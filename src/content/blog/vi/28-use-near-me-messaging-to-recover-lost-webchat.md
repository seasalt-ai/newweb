---
title: 'Người dùng đã rời khỏi webchat: sử dụng Near Me Messaging để gửi tin nhắn
  cho họ!'
description: 'Near Me Messaging giải quyết một vấn đề của webchat: liên lạc lại với
  người dùng của bạn ngay cả *sau khi* họ đã rời khỏi cuộc trò chuyện.'
...
image:
  ...
  alt: 'Người dùng đã rời khỏi webchat: sử dụng Near Me Messaging để gửi tin nhắn
    cho họ!'
tags:
- NearMe
lang: vi
