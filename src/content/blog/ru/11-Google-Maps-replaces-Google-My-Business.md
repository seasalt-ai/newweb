...
description: Google заменяет приложение Google Мой Бизнес на Google Карты, где компании
  могут управлять своей информацией и отвечать на сообщения клиентов в Google Картах.
...
image:
  ...
  alt: Прощай, Google Мой Бизнес, теперь Google Карты — новая ОС для бизнеса
tags: []
lang: ru
draft: false
---
