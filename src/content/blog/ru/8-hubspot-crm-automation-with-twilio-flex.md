...
description: В этом блоге мы рассмотрим интеграцию CRM, такой как HubSpot, в Seax
  Contact Center, что позволит вам получить прямой доступ ко всей информации и инструментам.
