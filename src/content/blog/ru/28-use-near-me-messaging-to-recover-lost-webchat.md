---
title: 'Пользователь покинул веб-чат: используйте Near Me Messaging, чтобы отправить
  ему сообщение!'
description: 'Near Me Messaging решает одну проблему веб-чата: свяжитесь с пользователем
  даже *после* того, как он покинул разговор.'
...
image:
  ...
  alt: 'Пользователь покинул веб-чат: используйте Near Me Messaging, чтобы отправить
    ему сообщение!'
tags:
- NearMe
lang: ru
