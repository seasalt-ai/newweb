...
description: 'В этом блоге мы рассмотрим «распределенные» контакт-центры: что это
  такое, как они могут принести вам пользу и как SeaX использует это для лучшего обслуживания
  наших клиентов.'
publishDate: '2022-07-27'
author: Sarah Reid
image:
  url: /images/blog/20-seax-distributed-contact-center/0-main.png
  alt: Расширьте охват вашего контакт-центра с помощью распределенного контакт-центра
tags:
- SeaX
lang: ru
draft: false
