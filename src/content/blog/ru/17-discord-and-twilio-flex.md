---
title: 'Discord (3/3): Discord и Twilio Flex: Перенос контакт-центра Flex на неизведанную
  территорию'
description: В этом блоге мы продемонстрируем, как Seasalt.ai интегрировала полнофункциональный
  контакт-центр в сервер Discord.
...
image:
  ...
  alt: 'Discord (3/3): Discord и Twilio Flex: Перенос контакт-центра Flex на неизведанную
    территорию'
tags:
- SeaX
- Discord
