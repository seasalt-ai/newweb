...
description: В этом блоге мы обсудим наши выводы о том, как реальные пользователи
  Discord используют сервисы SeaVoice после анализа нескольких недель аутентичных
  данных преобразования речи в текст.
...
Благодарим вас за интерес к нашему боту Discord и благодарим наших пользователей за постоянную поддержку! Вы можете узнать больше о нашем продукте STT на нашей [домашней странице SeaVoice Speech-to-Text](https://suite.seasalt.ai/tts). Для индивидуальной демонстрации любого из наших продуктов Voice Intelligence заполните [форму бронирования демонстрации](https://calendar.app.google/FLjCxzbYLqG6CkNs9).
