...
Благодарим вас за интерес к нашему боту Discord и благодарим наших пользователей за постоянную поддержку! Вы можете узнать больше о нашем продукте STT на нашей [домашней странице SeaVoice Speech-to-Text](https://suite.seasalt.ai/tts). Для индивидуальной демонстрации любого из наших продуктов Voice Intelligence заполните [форму бронирования демонстрации](https://calendar.app.google/GcdRQv1DVoiDaoCT6).
