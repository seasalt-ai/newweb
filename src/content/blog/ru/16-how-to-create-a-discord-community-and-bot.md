...
description: В этом блоге мы рассмотрим создание сервера для вашего бренда и подключение
  бота, который может автоматизировать модерацию, отчеты об ошибках, объявления и
  т.д.
...
image:
  ...
  alt: 'Discord (2/3): Как создать сообщество Discord и бота для вашего бренда'
tags:
- SeaX
- Discord
lang: ru
