...
description: В этом блоге мы представим SeaX, наше облачное решение для контакт-центра.
  Это первая из серии блогов, которая подробно представит и покажет функции SeaX.
...
image:
  ...
  alt: Добро пожаловать в SeaX, совместный облачный контакт-центр
tags:
- SeaX
lang: ru
draft: false
...
Для личной демонстрации и чтобы узнать, как SeaX может помочь с потребностями вашего контакт-центра, пожалуйста, заполните нашу форму «[Заказать демонстрацию](https://calendar.app.google/GcdRQv1DVoiDaoCT6)».
