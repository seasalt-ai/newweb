...
description: Ведущая нигерийская компания по цифровым платежам достигла революционной
  поддержки клиентов с помощью омниканального контакт-центра, интегрирующего чат-ботов
  и персонализированную поддержку на пиджин-английском языке, что принесло пользу
  миллионам пользователей и продавцов.
