...
Благодарим вас за интерес к нашему боту Discord и проектам голосового интеллекта! Вы можете узнать больше о нашем продукте STT на нашей [домашней странице преобразования речи в текст](https://suite.seasalt.ai/tts). Для индивидуальной демонстрации любого из наших продуктов голосового интеллекта заполните [форму бронирования демонстрации](https://calendar.app.google/GcdRQv1DVoiDaoCT6).
