...
저희 디스코드 봇 및 음성 지능 프로젝트에 관심을 가져주셔서 감사합니다! STT 제품에 대한 자세한 내용은 [음성 텍스트 변환 홈페이지](https://suite.seasalt.ai/tts)에서 확인할 수 있습니다. 음성 지능 제품 중 하나에 대한 일대일 데모를 원하시면 [데모 예약 양식](https://calendar.app.google/GcdRQv1DVoiDaoCT6)을 작성하십시오.
