...
description: Google Business Profile은 사업주가 고객과 직접 채팅할 수 있게 하지만, Google Business Messages는
  가상 고객 서비스와의 통합을 가능하게 합니다.
...
image:
  ...
  alt: '사업주: 영업시간 외에 Google Business Messages를 사용하여 고객과 소통하세요!'
tags:
- NearMe
lang: ko
draft: false
