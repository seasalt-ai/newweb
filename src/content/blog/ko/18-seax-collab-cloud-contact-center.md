...
description: 이 블로그에서는 클라우드 커뮤니케이션 컨택 센터 솔루션인 SeaX를 소개합니다. 이 블로그는 SeaX를 소개하는 시리즈의 첫
  번째입니다.
...
개인 데모를 원하시거나 SeaX가 귀하의 컨택 센터 요구 사항에 어떻게 도움이 되는지 확인하려면 "[데모 예약](https://calendar.app.google/FLjCxzbYLqG6CkNs9)" 양식을 작성해 주세요.
