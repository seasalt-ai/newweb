---
title: 'کاربر وب‌چت را ترک کرده است: از پیام‌رسانی نزدیک من برای ارسال پیام به او
  استفاده کنید!'
description: 'پیام‌رسانی نزدیک من یک مشکل وب‌چت را حل می‌کند: حتی *پس از* ترک مکالمه
  توسط کاربر، دوباره با او در تماس باشید.'
...
image:
  ...
  alt: 'کاربر وب‌چت را ترک کرده است: از پیام‌رسانی نزدیک من برای ارسال پیام به او
    استفاده کنید!'
tags:
- NearMe
lang: fa
