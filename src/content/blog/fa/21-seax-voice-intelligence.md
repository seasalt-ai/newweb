...
description: در این وبلاگ، ما نشان خواهیم داد که چگونه موتورهای داخلی تبدیل متن به
  گفتار و گفتار به متن Seasalt.ai می‌توانند جنبه‌های مختلف پلتفرم SeaX را بهبود بخشند.
...
image:
  ...
  alt: به مرکز تماس خود با SeaX Voice Intelligence صدای خود را بدهید
tags:
- SeaX
lang: fa
draft: false
