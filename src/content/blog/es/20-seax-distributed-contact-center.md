...
description: 'En este blog, analizaremos los centros de contacto ''distribuidos'':
  qué son, cómo pueden beneficiarle y cómo SeaX los utiliza para servir mejor a nuestros
  clientes.'
...
image:
  ...
  alt: Expanda la huella de su centro de contacto con un centro de contacto distribuido
tags:
- SeaX
lang: es
draft: false
