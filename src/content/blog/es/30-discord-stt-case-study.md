...
description: En este blog, discutiremos nuestros hallazgos sobre cómo los usuarios
  reales de Discord utilizan los servicios de SeaVoice después de revisar varias semanas
  de datos auténticos de voz a texto.
publishDate: '2023-01-23'
author: Kim Dodds
image:
  url: /images/blog/30-stt-case-study/discord-stt-bot-case-study.jpg
  alt: 'Voz a texto en Discord: un estudio de caso del bot STT de Discord'
tags:
- SeaVoice
- Discord
lang: es
