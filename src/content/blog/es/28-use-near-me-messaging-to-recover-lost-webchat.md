---
title: 'El usuario ha abandonado el chat web: ¡use Near Me Messaging para enviarle
  un mensaje!'
description: 'Near Me Messaging resuelve un problema del chat web: vuelva a ponerse
  en contacto con su usuario incluso *después* de que haya abandonado la conversación.'
...
image:
  ...
  alt: 'El usuario ha abandonado el chat web: ¡use Near Me Messaging para enviarle
    un mensaje!'
tags:
- NearMe
lang: es
