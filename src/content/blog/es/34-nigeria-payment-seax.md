---
title: 'Historia de cliente: Éxito del centro de contacto en la industria de pagos
  digitales de Nigeria'
description: La principal empresa de pagos digitales de Nigeria logró un soporte al
  cliente revolucionario con un centro de contacto omnicanal, que integra chatbots
  y soporte personalizado en Pidgin English, beneficiando a millones de usuarios y
  comerciantes.
...
image:
  ...
  alt: 'Historia de cliente: Éxito del centro de contacto en la industria de pagos
    digitales de Nigeria'
tags:
- SeaX
- Customer Story
...
Si está interesado en obtener más información sobre SeaX, complete nuestro formulario "[Reservar una demostración](https://calendar.app.google/GcdRQv1DVoiDaoCT6)" para obtener una primera vista de la plataforma SeaX. ¡Siempre estamos encantados de chatear!
