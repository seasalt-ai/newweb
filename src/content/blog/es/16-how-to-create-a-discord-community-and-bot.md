...
description: En este blog, te guiaremos a través de la creación de un servidor para
  tu marca y la conexión de un bot, que puede automatizar la moderación, el informe
  de errores, los anuncios, etc.
...
image:
  ...
  alt: 'Discord (2/3): Cómo Crear una Comunidad y un Bot de Discord para tu Marca'
tags:
- SeaX
- Discord
lang: es
