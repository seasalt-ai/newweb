---
title: 'L''utilisateur a quitté le webchat : utilisez Near Me Messaging pour lui envoyer
  un message !'
description: 'Near Me Messaging résout un problème du webchat : reprendre contact
  avec votre utilisateur même *après* qu''il ait quitté la conversation.'
...
image:
  ...
  alt: 'L''utilisateur a quitté le webchat : utilisez Near Me Messaging pour lui envoyer
    un message !'
tags:
- NearMe
lang: fr
