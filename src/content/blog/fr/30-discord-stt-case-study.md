...
description: Dans ce blog, nous discuterons de nos découvertes sur la façon dont les
  utilisateurs réels de Discord utilisent les services SeaVoice après avoir examiné
  plusieurs semaines de données authentiques de voix-texte.
publishDate: '2023-01-23'
author: Kim Dodds
image:
  url: /images/blog/30-stt-case-study/discord-stt-bot-case-study.jpg
  alt: 'Voix-texte sur Discord : une étude de cas du bot Discord STT'
tags:
- SeaVoice
- Discord
lang: fr
