---
title: 'Témoignage client : Succès du centre de contact dans l''industrie du paiement
  numérique au Nigeria'
description: La principale entreprise de paiement numérique du Nigeria a révolutionné
  le support client grâce à un centre de contact omnicanal, intégrant des chatbots
  et un support personnalisé en pidgin anglais, bénéficiant à des millions d'utilisateurs
  et de commerçants.
...
image:
  ...
  alt: 'Témoignage client : Succès du centre de contact dans l''industrie du paiement
    numérique au Nigeria'
tags:
- SeaX
- Customer Story
