...
description: W tym blogu przeprowadzimy Cię przez proces tworzenia serwera dla Twojej
  marki i podłączania bota, który może automatyzować moderację, zgłaszanie błędów,
  ogłoszenia itp.
...
image:
  ...
  alt: 'Discord (2/3): Jak stworzyć społeczność i bota na Discordzie dla Twojej marki'
tags:
- SeaX
- Discord
lang: pl
