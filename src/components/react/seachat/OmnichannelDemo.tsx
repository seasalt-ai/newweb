  ...
  const channels = useMemo(
    () => [
      ...
      },
      {
        ...
        features: [
          getText('seachat.features.omnichannel.channels.line.features.0', 'Official Account integration'),
          getText('seachat.features.omnichannel.channels.line.features.1', 'Rich media support'),
          getText('seachat.features.omnichannel.channels.line.features.2', 'Stickers and emoji'),
          getText('seachat.features.omnichannel.channels.line.features.3', 'Automated replies'),
        ],
      },
      {
        id: "email",
      ...
      },
      {
        ...
        features: [
          getText('seachat.features.omnichannel.channels.ecommerce.features.0', 'Order tracking'),
          getText('seachat.features.omnichannel.channels.ecommerce.features.1', 'Product information'),
          getText('seachat.features.omnichannel.channels.ecommerce.features.2', 'Inventory checks'),
          getText('seachat.features.omnichannel.channels.ecommerce.features.3', 'Shopping cart recovery'),
        ],
      },
    ],
    [getText]
