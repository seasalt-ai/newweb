...
const FintechPage = ({ lang, translations }: FintechPageProps) => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: getText(
        ...
        "Comprehensive payment processing support and dispute resolution"
      ),
      benefits: [
        getText(
    ...
    },
    {
      ...
      description: getText(
        ...
        "AI-powered investment advice and portfolio management support"
      ),
      benefits: [
        getText(
    ...
    },
    {
      ...
      description: getText(
        ...
        "Built-in compliance with financial regulations and reporting requirements"
      ),
      benefits: [
        getText(
  ...
  const useCases = [
    {
      ...
      description: getText(
        ...
        "Help customers with account setup, verification, and management"
      ),
      example: getText(
        "seachat.solutions.fintech.useCases.account.example",
        '"I need help setting up my business account"'
      ),
      outcome: getText(
        "seachat.solutions.fintech.useCases.account.outcome",
        "Guided account setup with document verification and compliance checks"
      ),
    },
    {
      title: getText(
      ...
      description: getText(
        ...
        "Provide real-time transaction status and history information"
      ),
      example: getText(
        "seachat.solutions.fintech.useCases.transaction.example",
        '"Where is my wire transfer to ABC Company?"'
      ),
      outcome: getText(
    ...
    },
    {
      ...
      description: getText(
        ...
        "Detect and prevent fraudulent activities with AI monitoring"
      ),
      example: getText(
        "seachat.solutions.fintech.useCases.fraud.example",
        '"I see a suspicious charge on my account"'
      ),
      outcome: getText(
        "seachat.solutions.fintech.useCases.fraud.outcome",
        "Immediate fraud investigation and account protection measures"
      ),
    },
    {
      title: getText(
      ...
      description: getText(
        ...
        "Provide investment guidance and portfolio management assistance"
      ),
      example: getText(
      ...
      outcome: getText(
        ...
        "Personalized investment advice based on risk profile and market analysis"
      ),
    },
  ];
  ...
  const metrics = [
    {
      ...
      description: getText(
        ...
        "With automated processing and verification"
      ),
    },
    {
      value: "75%",
      ...
      description: getText(
        ...
        "For financial inquiries and disputes"
      ),
    },
    {
      value: "90%",
    ...
    },
    {
      ...
      description: getText(
        ...
        "For financial support interactions"
      ),
    },
  ];

  // Try to get securityFeatures from translations, provide fallback if not available
  const getSecurityFeatures = () => {
    try {
      const features =
        translations?.seachat?.solutions?.fintech?.securityFeatures;
      if (Array.isArray(features)) {
        return features;
      }
    } catch (e) {
      // Fallback to static features if translation doesn't exist
    }
  ...
  const regulations = [
    ...
    {
      name: getText("seachat.solutions.fintech.regulations.sox.name", "SOX"),
      description: getText(
    ...
    {
      name: getText("seachat.solutions.fintech.regulations.gdpr.name", "GDPR"),
      description: getText(
    ...
    {
      name: getText("seachat.solutions.fintech.regulations.ccpa.name", "CCPA"),
      description: getText(
          ...
          <div className="text-center">
            ...
            <p className="text-2xl text-green-200 mb-8 max-w-4xl mx-auto">
              {getText(
                ...
                "Secure, compliant customer support for financial services. Handle transactions, provide investment guidance, and ensure regulatory compliance with confidence."
              )}
            </p>
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {getText(
                ...
                "Purpose-built features for financial institutions to deliver secure, compliant customer support."
              )}
            </p>
          </div>
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {getText(
                ...
                "Real results from financial institutions using SeaChat for customer support."
              )}
            </p>
          </div>
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              {getText(
                ...
                "Financial Support Use Cases"
              )}
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {getText(
                "seachat.solutions.fintech.useCasesSubtitle",
                "See how SeaChat handles complex financial inquiries and transactions."
              )}
            </p>
          </div>
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                {getText(
                  ...
                  "Built with the highest security standards and regulatory compliance requirements for financial services institutions."
                )}
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-100 mb-8 max-w-3xl mx-auto">
            {getText(
              ...
              "Join financial institutions already using SeaChat to deliver secure, compliant customer support that builds trust and drives growth."
            )}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
