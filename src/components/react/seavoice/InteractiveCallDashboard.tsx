...
const InteractiveCallDashboard: React.FC<InteractiveCallDashboardProps> = ({ lang }) => {
  ...
  const conversationBubbles = [
    { id: 1, text: getText('seavoice.components.interactiveCallDashboard.conversations.appointmentRequest', 'Appointment request handled'), x: 15, y: 20, delay: 0 },
    { id: 2, text: getText('seavoice.components.interactiveCallDashboard.conversations.techCorpGreeting', 'TechCorp greeting completed'), x: 70, y: 35, delay: 1 },
    { id: 3, text: getText('seavoice.components.interactiveCallDashboard.conversations.orderTracking', 'Order tracking inquiry'), x: 25, y: 65, delay: 2 },
    { id: 4, text: getText('seavoice.components.interactiveCallDashboard.conversations.availabilityResponse', 'Availability confirmed'), x: 80, y: 80, delay: 3 },
  ];

  // Helper function to get meeting URL (simplified)
  const getMeetingUrl = (language: string) => {
    return 'https://meetings.hubspot.com/seasalt-ai/seasalt-demo';
  };
  ...
  return (
    <section className="relative bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 py-20 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0">
        {clientMounted && particles.map((particle) => (
          <motion.div
            key={particle.id}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              {getText('seavoice.components.interactiveCallDashboard.liveDashboard', 'Live Dashboard')}
            </motion.div>

            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white leading-tight mb-8">
              <span className="block">{getText('seavoice.components.interactiveCallDashboard.controlCenter', 'Control Center')}</span>
              <span className="bg-gradient-to-r from-blue-300 to-purple-300 bg-clip-text text-transparent">
                {getText('seavoice.components.interactiveCallDashboard.realTimeAnalytics', 'Real-time Analytics')}
              </span>
            </h1>

            <p className="text-xl text-blue-100 leading-relaxed mb-8">
              {getText('seavoice.components.interactiveCallDashboard.description', 'Monitor and manage your voice AI operations with comprehensive real-time insights.')}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                {getText('seavoice.components.interactiveCallDashboard.bookDemo', 'Book a Demo')}
          ...
          >
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-semibold text-white">{getText('seavoice.components.interactiveCallDashboard.controlCenterTitle', 'Command Center')}</h3>
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <span className="text-green-300 text-sm">{getText('seavoice.components.interactiveCallDashboard.live', 'Live')}</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                ...
                >
                  ...
                  <div className="text-blue-200 text-sm">{getText('seavoice.components.interactiveCallDashboard.activeCalls', 'Active Calls')}</div>
                </motion.div>
                ...
                <div className="text-center p-4 bg-purple-500/20 rounded-lg">
                  ...
                  <div className="text-purple-200 text-sm">{getText('seavoice.components.interactiveCallDashboard.avgQueueTime', 'Avg Queue Time')}</div>
                </div>
                ...
                <div className="text-center p-4 bg-green-500/20 rounded-lg">
                  ...
                  <div className="text-green-200 text-sm">{getText('seavoice.components.interactiveCallDashboard.resolutionRate', 'Resolution Rate')}</div>
                </div>

                <div className="text-center p-4 bg-orange-500/20 rounded-lg">
                  <div className="text-3xl font-bold text-orange-400 mb-2">24/7</div>
                  <div className="text-orange-200 text-sm">{getText('seavoice.components.interactiveCallDashboard.availability', 'Availability')}</div>
                </div>
              </div>
              ...
              <div className="relative h-32 bg-slate-800/50 rounded-lg overflow-hidden mb-6">
                ...
                <div className="absolute bottom-2 left-2 text-xs text-blue-200">
                  {getText('seavoice.components.interactiveCallDashboard.globalCallActivity', 'Global Call Activity')}
                </div>
              </div>

              {/* Recent Activity */}
              <div className="space-y-3">
                <div className="text-sm font-medium text-white mb-3">{getText('seavoice.components.interactiveCallDashboard.recentConversations', 'Recent Conversations')}</div>
                {[
                  getText('seavoice.components.interactiveCallDashboard.customerInquiryResolved', 'Customer inquiry resolved'), 
                  getText('seavoice.components.interactiveCallDashboard.appointmentScheduled', 'Appointment scheduled'), 
                  getText('seavoice.components.interactiveCallDashboard.paymentProcessed', 'Payment processed'), 
                  getText('seavoice.components.interactiveCallDashboard.supportTicketCreated', 'Support ticket created')
                ].map((activity, index) => (
                  <motion.div
                    key={activity}
                  ...
                  >
                    ...
                    <span className="text-xs text-blue-300 ml-auto">{getText('seavoice.components.interactiveCallDashboard.justNow', 'Just now')}</span>
                  </motion.div>
                ))}
              </div>
            </div>
            ...
            >
              ...
              <div className="text-sm opacity-90">{getText('seavoice.components.interactiveCallDashboard.concurrentCalls', 'Concurrent Calls')}</div>
            </motion.div>
            ...
            >
              ...
              <div className="text-sm opacity-90">{getText('seavoice.components.interactiveCallDashboard.uptime', 'Uptime')}</div>
            </motion.div>
          </motion.div>
        </div>
      </div>
