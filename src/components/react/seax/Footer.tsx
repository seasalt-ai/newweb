...
const Footer = ({
  ...
  const getWikiUrl = () => {
    const wikiLanguage =
      currentLanguage === "zh-TW" || currentLanguage === "zh-CN" ? "zh" : "en";
  ...
  const getMeetingUrl = () => {
    ...
    return (
      meetingUrls[currentLanguage as keyof typeof meetingUrls] || meetingUrls.en
    );
  };
  ...
  const toggleMobileSection = (
    section: "channels" | "solutions" | "industries" | "company"
  ) => {
  ...
  const channelLinks = [
    {
      name: translations.footer?.links?.channels?.smsOverview || "SMS Overview",
      path: "/channels/sms",
      icon: MessageSquare,
      iconText: "SMS",
      isParent: true,
    ...
    {
      name: translations.footer?.links?.channels?.smsLocal || "Local Number",
      path: "/channels/sms-local",
      icon: Building2,
      iconText: "10DLC",
      isChild: true,
    },
    {
      name: translations.footer?.links?.channels?.smsTollFree || "Toll-Free",
      path: "/channels/sms-toll-free",
      icon: Phone,
      iconText: "8XX",
      isChild: true,
    },
    {
      name: translations.footer?.links?.channels?.smsShortCode || "Short Code",
      path: "/channels/sms-short-code",
      icon: Hash,
      iconText: "xxxxx",
      isChild: true,
    },
    {
      name:
        translations.footer?.links?.channels?.whatsapp || "WhatsApp Business",
      path: "/channels/whatsapp",
      icon: WhatsAppIcon,
    },
    {
      name: translations.footer?.links?.channels?.voice || "Phone Call & Voice",
      path: "/channels/voice",
      icon: Phone,
    },
  ];
  ...
  const solutionLinks = [
    {
      name:
        translations.footer?.links?.solutions?.leadGeneration ||
        "Lead Generation",
    ...
    {
      name:
        translations.footer?.links?.solutions?.marketingAutomation ||
    ...
    {
      name:
        translations.footer?.links?.solutions?.customerEngagement ||
        "Customer Engagement",
    ...
    {
      name:
        translations.footer?.links?.solutions?.appointmentReminders ||
        "Appointment Reminders",
      path: "/solutions/appointment-reminders",
      icon: Calendar,
    },
    {
      name:
        translations.footer?.links?.solutions?.emergencyAlerts ||
        "Emergency Alerts",
      path: "/solutions/emergency-alerts",
      icon: AlertTriangle,
    },
  ];
  ...
  const industryLinks = [
    {
      name:
        translations.footer?.links?.industries?.ecommerceRetail ||
        "E-commerce & Retail",
      path: "/industries/ecommerce-retail",
      icon: ShoppingCart,
    },
    {
      name: translations.footer?.links?.industries?.realEstate || "Real Estate",
      path: "/industries/real-estate",
      icon: Building2,
    },
    {
      name:
        translations.footer?.links?.industries?.politicalCampaigns ||
        "Political Campaigns",
      path: "/industries/political-campaigns",
      icon: Vote,
    },
    {
      name: translations.footer?.links?.industries?.healthcare || "Healthcare",
      path: "/industries/healthcare",
      icon: Heart,
    },
    {
      name:
        translations.footer?.links?.industries?.financialServices ||
        "Financial Services",
  ...
  const companyLinks = [
    {
      name: translations.header?.blog || "Blog",
      href: `/${currentLanguage}/blog`,
      icon: MessageSquare,
    },
    {
      name: translations.header?.pricing || "Pricing",
      href: getLocalizedPath("/pricing"),
      icon: DollarSign,
    },
    {
      name: translations.header?.compareUs || "Compare Us",
      href: `/${currentLanguage}/compare-us-overview`,
      icon: BarChart3,
    },
    {
      name: translations.footer?.links?.company?.productWiki || "Product Wiki",
      href: getWikiUrl(),
      icon: Book,
    },
    {
      name:
        translations.footer?.links?.company?.apiReferences || "API References",
      href: "https://api.seasalt.ai",
      icon: Server,
    },
    {
      name: translations.footer?.links?.company?.careers || "Careers",
      href: `/${currentLanguage}/careers`,
      icon: Briefcase,
    },
    {
      name: translations.footer?.company?.about || "About",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-2 sm:gap-3 lg:gap-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base">
              {translations.footer?.description?.company ||
                "AI-powered SMS and voice communication platform for businesses"}
            </p>
            <div className="space-y-2 sm:space-y-3">
              <div className="flex items-center text-gray-300">
                <Phone className="h-4 w-4 mr-2" />
                <span className="text-sm">
                  {translations.footer?.contact?.phone || "+1 (SMB)-AI-AGENT"}
                </span>
              </div>
              <div className="flex items-center text-gray-300">
                <Mail className="h-4 w-4 mr-2" />
                <span className="text-sm">
                  {translations.footer?.contact?.email || "info@seasalt.ai"}
                </span>
              </div>
              <div className="flex items-center text-gray-300">
                <MapPin className="h-4 w-4 mr-2" />
                <span className="text-sm">
                  {translations.footer?.contact?.location || "Seattle, WA"}
                </span>
              </div>
            </div>
          ...
          <div>
            ...
            >
              {translations.footer?.section?.channels || "Channels"}
              <ChevronDown
                className={`w-4 h-4 transition-transform ${mobileCollapsed.channels ? "" : "rotate-180"}`}
              />
            </button>
          ...
          <div>
            ...
            >
              {translations.footer?.section?.solutions || "Solutions"}
              <ChevronDown
                className={`w-4 h-4 transition-transform ${mobileCollapsed.solutions ? "" : "rotate-180"}`}
              />
            </button>
          ...
          <div>
            ...
            >
              {translations.footer?.section?.industries || "Industries"}
              <ChevronDown
                className={`w-4 h-4 transition-transform ${mobileCollapsed.industries ? "" : "rotate-180"}`}
              />
            </button>
          ...
          <div>
            ...
            >
              {translations.footer?.company?.title || "Company"}
              <ChevronDown
                className={`w-4 h-4 transition-transform ${mobileCollapsed.company ? "" : "rotate-180"}`}
              />
            </button>
                ...
                {!mobileCollapsed.company && (
                  ...
                  >
                    ...
                    <li>
                      ...
                      >
                        <Zap className="h-3 w-3 mr-2 text-blue-400" />
                        {translations.footer?.links?.company?.features ||
                          "Features"}
                      </a>
                    </li>
                    <li>
                      ...
                      >
                        <DollarSign className="h-3 w-3 mr-2 text-blue-400" />
                        {translations.footer?.links?.company?.pricing ||
                          "Pricing"}
                      </a>
                    </li>
                    {/* Then company links */}
        ...
        <div className="border-t border-gray-800 mt-8 sm:mt-12 pt-6 sm:pt-8">
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-4 md:space-x-6 mb-2 lg:mb-0">
              <p className="text-gray-300 text-sm">
                {translations.footer?.copyright?.replace(
                  ...
                  `© ${new Date().getFullYear()} SeaX by Seasalt.ai. All rights reserved.`}
              </p>
          ...
          <div className="text-center mt-4">
            <p className="text-gray-300 text-sm">
              {translations.footer?.madeWith?.text || "Made with"}{" "}
              <Heart className="inline w-4 h-4 text-red-500" />{" "}
              {translations.footer?.madeWith?.inCityOf || "in the city of"}{" "}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center overflow-hidden">
          <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4">
            {translations.footer?.cta?.title ||
              "Ready to supercharge your business communication?"}
          </h3>
          <p className="text-white opacity-90 mb-6 max-w-2xl mx-auto">
            {translations.footer?.cta?.subtitle ||
              "Join thousands of businesses using SeaX to streamline their SMS and voice communications."}
          </p>
