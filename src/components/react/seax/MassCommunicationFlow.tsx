...
const MassCommunicationFlow: React.FC<MassCommunicationFlowProps> = ({ lang, onStatsUpdate, translations }) => {
  ...
  const messageTypes = React.useMemo(() => [
    { type: getText('seax.massCommunicationFlow.messageTypes.sms', 'SMS'), icon: MessageCircle, color: 'text-blue-300', bgColor: 'bg-blue-500/40' },
    { type: getText('seax.massCommunicationFlow.messageTypes.whatsapp', 'WhatsApp'), icon: Smartphone, color: 'text-green-300', bgColor: 'bg-green-500/40' },
    { type: getText('seax.massCommunicationFlow.messageTypes.voice', 'Voice'), icon: Phone, color: 'text-purple-300', bgColor: 'bg-purple-500/40' },
    { type: getText('seax.massCommunicationFlow.messageTypes.email', 'Email'), icon: Mail, color: 'text-orange-300', bgColor: 'bg-orange-500/40' }
  ], [getText]);
