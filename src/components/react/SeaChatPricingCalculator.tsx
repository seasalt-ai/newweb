...
const SeaChatPricingCalculator: React.FC<PricingCalculatorProps> = ({
  lang,
  translations,
}) => {
  ...
  const [calculatorBilling, setCalculatorBilling] = useState<
    "monthly" | "yearly"
  >("monthly");
  ...
  const calculateUsageCost = () => {
    const model = pricingData.pricing.find(
      (p) => p.model_name === selectedModel
    );
    if (!model) return 0;

    const textCost = model.per_text_response
      ? chatResponses * model.per_text_response
      : 0;
  ...
  const getCalculatorTotalCost = () => {
    ...
    return calculatorBilling === "yearly"
      ? monthlyTotal + (usageCost + addonsCost) * 11
      : monthlyTotal;
  };
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8">
            {getText(
              "seachat.pricing.calculator.description",
              "Estimate your monthly costs based on your usage needs"
            )}
          </p>
          ...
          <div className="flex items-center justify-center mb-6">
            ...
            <button
              onClick={() =>
                setCalculatorBilling(
                  calculatorBilling === "monthly" ? "yearly" : "monthly"
                )
              }
        ...
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-3xl p-8 shadow-xl">
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div>
              <label className="block text-lg font-semibold text-gray-900 mb-4">
                {getText(
                  "seachat.pricing.calculator.modelSelect",
                  "Select AI Model"
                )}
              </label>
              <select
              ...
              >
                {pricingData.pricing
                  .filter((model) => model.plans.includes("Omnichannel"))
                  .map((model) => (
                  ...
                  return model ? (
                    <div className="space-y-1">
                      {model.per_text_response ? (
                        <div>
                          ${model.per_text_response.toFixed(3)}{" "}
                          {getText(
                            "seachat.pricing.calculator.perChatResponse",
                            "per chat response"
                          )}
                        </div>
                      ) : (
                        <div className="text-gray-500 italic">
                          {getText(
                            "seachat.pricing.calculator.voiceOnly",
                            "Voice only model"
                          )}
                        </div>
                      )}
                      <div>
                        <div className="font-medium text-gray-700 mb-1">
                          {getText(
                            "seachat.pricing.calculator.voicePricing",
                            "Voice pricing"
                          )}
                          :
                        </div>
                        <div className="ml-2 space-y-0.5">
                          <div>
                            ...
                            (
                            {getText(
                              "seachat.pricing.calculator.standardVoice",
                              "Whatsapp"
                            )}
                            )
                          </div>
                          <div>
                            ...
                            (
                            {getText(
                              "seachat.pricing.calculator.premiumVoice",
                              "Omnichannel"
                            )}
                            )
                          </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-orange-200">
              <h3 className="text-xl font-bold text-gray-900 mb-4">
                {getText(
                  "seachat.pricing.calculator.priceBreakdown",
                  "Price Breakdown"
                )}
              </h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">
                    {calculatorBilling === "yearly"
                      ? getText(
                          "seachat.pricing.calculator.licenseYearly",
                          "License Fee (Yearly)"
                        )
                      : getText(
                          "seachat.pricing.calculator.licenseFee",
                          "License Fee"
                        )}
                  </span>
                ...
                {calculatorBilling === "yearly" && (
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">
                      {getText(
                        "seachat.pricing.calculator.usageCostYearly",
                        "Usage Cost (Yearly)"
                      )}
                    </span>
                    <span className="font-semibold">
                      ${(calculateUsageCost() * 12).toFixed(2)}
                    </span>
                  </div>
                )}
                {calculatorBilling === "monthly" && (
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">
                      {getText(
                        "seachat.pricing.calculator.usageCost",
                        "Usage Cost"
                      )}
                    </span>
                    <span className="font-semibold">
                      ${calculateUsageCost().toFixed(2)}
                    </span>
                  </div>
                )}
                {calculatorBilling === "yearly" && (
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">
                      {getText(
                        "seachat.pricing.calculator.addOnsCostYearly",
                        "Add-ons Cost (Yearly)"
                      )}
                    </span>
                    <span className="font-semibold">
                      ${(calculateAddonsCost() * 12).toFixed(2)}
                    </span>
                  </div>
                )}
                {calculatorBilling === "monthly" && (
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">
                      {getText(
                        "seachat.pricing.calculator.addOnsCost",
                        "Add-ons Cost"
                      )}
                    </span>
                    <span className="font-semibold">
                      ${calculateAddonsCost().toFixed(2)}
                    </span>
                  </div>
                )}
                <div className="border-t border-orange-200 pt-3">
                  <div className="flex justify-between items-center text-xl">
                    <span className="font-bold text-gray-900">
                      {calculatorBilling === "yearly"
                        ? getText(
                            "seachat.pricing.calculator.totalPerYear",
                            "Total per Year"
                          )
                        : getText(
                            "seachat.pricing.calculator.totalPerMonth",
                            "Total per Month"
                          )}
                    </span>
                    <span className="font-bold text-orange-600">
                      ${getCalculatorTotalCost().toFixed(2)}
                    </span>
                  </div>
                  {calculatorBilling === "yearly" && (
                    <div className="flex justify-between items-center text-sm mt-2">
                      <span className="text-gray-500">
                        {getText(
                          "seachat.pricing.calculator.averagePerMonth",
                          "Average per month"
                        )}
                      </span>
                      <span className="text-gray-700 font-medium">
                        ${(getCalculatorTotalCost() / 12).toFixed(2)}
                      </span>
                    </div>
                  )}
                </div>
          ...
          <div className="space-y-8">
            ...
            <div>
              <h4 className="text-xl font-bold text-gray-900 mb-6">
                {getText("seachat.pricing.calculator.aiUsage", "AI Usage")}
              </h4>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <label className="block text-lg font-semibold text-gray-900 mb-4">
                    {getText(
                      "seachat.pricing.calculator.chatResponses",
                      "Chat Responses"
                    )}
                    :{" "}
                    <span className="text-orange-600">
                      {chatResponses.toLocaleString()}
                    </span>
                  </label>
                  <input
                    type="range"
                  ...
                  <div className="mt-3 text-center">
                    <div className="bg-white rounded-lg p-3 border border-orange-300">
                      <div className="text-sm text-gray-600 mb-1">
                        {getText(
                          "seachat.pricing.calculator.chatCost",
                          "Chat Cost"
                        )}
                      </div>
                      <div className="text-xl font-bold text-orange-600">
                        ...
                        {(() => {
                          ...
                          return model && model.per_text_response
                            ? (chatResponses * model.per_text_response).toFixed(
                                2
                              )
                            : "0.00";
                        })()}
                ...
                <div>
                  <label className="block text-lg font-semibold text-gray-900 mb-4">
                    {getText(
                      "seachat.pricing.calculator.voiceMinutes",
                      "Voice Minutes"
                    )}
                    :{" "}
                    <span className="text-orange-600">
                    ...
                    <div className="text-sm text-gray-500 mt-1">
                      {getText(
                        "seachat.pricing.calculator.voiceMinutesNote",
                        "AI voice conversations and phone calls"
                      )}
                    </div>
                  </label>
                  ...
                  <div className="mt-3 text-center">
                    <div className="bg-white rounded-lg p-3 border border-orange-300">
                      <div className="text-sm text-gray-600 mb-1">
                        {getText(
                          "seachat.pricing.calculator.voiceCost",
                          "Voice Cost"
                        )}
                      </div>
                      <div className="text-xl font-bold text-orange-600">
                        ...
                        {(() => {
                          ...
                          return model
                            ? (
                                voiceMinutes *
                                model.per_voice_minute[voiceQuality]
                              ).toFixed(2)
                            : "0.00";
                        })()}
                      </div>
            ...
            <div>
              <h4 className="text-xl font-bold text-gray-900 mb-6">
                {getText(
                  "seachat.pricing.calculator.additionalResources",
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  <label className="block text-base font-semibold text-gray-900 mb-3">
                    {getText(
                      "seachat.pricing.calculator.humanAgents",
                      "Human Agents"
                    )}
                    : <span className="text-orange-600">{humanAgents}</span>
                  </label>
                  <input
                    type="range"
                    min="1"
                  ...
                  <div className="mt-3 text-center">
                    <div className="bg-white rounded-lg p-3 border border-orange-300">
                      <div className="text-xs text-gray-500 mb-1">
                        {getText(
                          "seachat.pricing.calculator.included",
                          "Included"
                        )}
                        : 4
                      </div>
                      <div className="text-sm text-gray-600 mb-1">
                        {getText("seachat.pricing.calculator.extra", "Extra")}:{" "}
                ...
                <div>
                  <label className="block text-base font-semibold text-gray-900 mb-3">
                    {getText(
                      "seachat.pricing.calculator.aiAgents",
                      "AI Agents"
                    )}
                    : <span className="text-orange-600">{aiAgents}</span>
                  </label>
                  <input
                    type="range"
                    min="1"
                ...
                <div>
                  <label className="block text-base font-semibold text-gray-900 mb-3">
                    {getText(
                      "seachat.pricing.calculator.workspaces",
                      "Workspaces"
                    )}
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600">
              {getText(
                "seachat.pricing.calculator.disclaimer",
                "Estimated costs based on your selected usage. Actual costs may vary."
              )}
              <br />
              {getText(
                "seachat.pricing.calculator.disclaimerDetails",
                "Premium plan includes the features shown above as base allocation."
              )}
            </p>
            <div className="mt-4 bg-white rounded-lg p-4 text-sm">
              <div className="font-semibold text-gray-900 mb-2">
                {getText(
                  "seachat.pricing.calculator.planIncludes",
                  "Premium Plan Base Includes:"
                )}
              </div>
              <div className="grid md:grid-cols-3 gap-4 text-left">
                <div>
                  •{" "}
                  {getText(
                    "seachat.pricing.calculator.planIncludesHuman",
                    "4 Human Agents"
                  )}
                </div>
                <div>
                  •{" "}
                  {getText(
                    "seachat.pricing.calculator.planIncludesAI",
                    "10 AI Agents"
                  )}
                </div>
                <div>
                  •{" "}
                  {getText(
                    "seachat.pricing.calculator.planIncludesWorkspaces",
                    "2 Workspaces"
                  )}
                </div>
              </div>
