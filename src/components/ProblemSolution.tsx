  ...
  const problems = [
    {
      ...
      title: t('common.problemSolution.problems.fragmented.title', 'Fragmented Conversations'),
      description: t('common.problemSolution.problems.fragmented.description', 'Jumping between WhatsApp, phone logs, and web chat creates chaos and wastes time.'),
      color: 'text-red-600',
      bgColor: 'bg-red-100'
    },
    {
      icon: <Clock className="h-12 w-12" />,
      title: t('common.problemSolution.problems.lostRevenue.title', 'Lost Revenue'),
      description: t('common.problemSolution.problems.lostRevenue.description', 'Missed messages after-hours and slow responses mean lost leads and frustrated customers.'),
      color: 'text-orange-600',
      bgColor: 'bg-orange-100'
    },
    {
      icon: <Activity className="h-12 w-12" />,
      title: t('common.problemSolution.problems.overload.title', 'Operational Overload'),
      description: t('common.problemSolution.problems.overload.description', 'Your team is stretched thin managing too many tools instead of focusing on customers.'),
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="text-center mb-16">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
            {t('common.problemSolution.title', 'Losing Leads in a Maze of Apps and Inboxes?')}
          </h2>
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
            {t('common.problemSolution.subtitle', 'Your customers are trying to reach you everywhere. A missed message is a missed sale. Seasalt.ai brings all your communications into one place, so you never miss an opportunity.')}
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-6 sm:p-8 text-white">
            <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">
              {t('common.problemSolution.solution.title', 'Seasalt.ai: Your Omni-Channel Copiloted Solution')}
            </h3>
            {/* Unified Omni-Channel Hub Animation */}
            <div className="bg-white rounded-2xl shadow-2xl p-4 sm:p-6 relative z-10 mb-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-base sm:text-lg font-semibold text-gray-900">{t('common.problemSolution.solution.hubTitle', 'Unified Omni-Channel Hub')}</h3>
              ...
              <div className="flex space-x-1 mb-3 sm:mb-4 bg-gray-100 rounded-lg p-1">
                ...
                >
                  ...
                  {t('common.problemSolution.solution.tabs.support', 'Support')}
                </button>
                <button
                ...
                >
                  ...
                  {t('common.problemSolution.solution.tabs.marketing', 'Marketing')}
                </button>
              </div>

              <p className="text-xs sm:text-sm text-gray-500 mb-3 sm:mb-4">{t('common.problemSolution.solution.subtitle', 'AI & Human Agents, 24/7')}</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
              ...
              <div className="text-center">
                ...
                <h4 className="text-lg sm:text-xl font-semibold text-white mb-1 sm:mb-2">{t('common.problemSolution.solution.features.marketing.title', 'Copilot Your Marketing Campaigns')}</h4>
                <p className="text-white opacity-90 text-xs sm:text-sm">
                  {t('common.problemSolution.solution.features.marketing.description', 'Acquire more customers with AI-driven outbound campaigns and smart lead nurturing.')}
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="text-lg sm:text-xl font-semibold text-white mb-1 sm:mb-2">{t('common.problemSolution.solution.features.support.title', 'Autopilot Your Customer Support')}</h4>
                <p className="text-white opacity-90 text-xs sm:text-sm">
                  {t('common.problemSolution.solution.features.support.description', 'Reduce support costs with 24/7 AI agents handling routine queries and seamless human handoff.')}
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="text-lg sm:text-xl font-semibold text-white mb-1 sm:mb-2">{t('common.problemSolution.solution.features.human.title', 'Never Lose the Human Touch')}</h4>
                <p className="text-white opacity-90 text-xs sm:text-sm">
                  {t('common.problemSolution.solution.features.human.description', 'Choose your automation level: Human-only, AI Copilot, or Full Autopilot based on your needs.')}
                </p>
              </div>
            </div>
            ...
            >
              {t('common.problemSolution.solution.cta', 'Use Seasalt.ai to Solve This')}
            </a>
          </div>
        </div>
      </div>
