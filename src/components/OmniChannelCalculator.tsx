      ...
      <div className="text-center mb-8">
        <div className="flex items-center justify-center space-x-2 mb-4">
          ...
          <h2 className="text-3xl font-bold text-gray-900">
            {getText('seax.pricing.omniCalculator.title', 'Omni-channel Cost Calculator')}
          </h2>
        </div>
        <p className="text-lg text-gray-600">
          {getText('seax.pricing.omniCalculator.subtitle', 'Calculate your monthly costs based on your usage')}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <h3 className="text-xl font-semibold text-gray-900 mb-4">
            {getText('seax.pricing.omniCalculator.configureTitle', 'Configure Your Setup')}
          </h3>
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-2">
              ...
              <label className="text-sm font-medium text-gray-700">
                {getText('seax.pricing.omniCalculator.users.label', 'Number of Users')}
              </label>
            </div>
            ...
            <p className="text-sm text-gray-500">
              {getText('seax.pricing.omniCalculator.users.pricing', {
                first: billingPeriod === 'monthly' ? '$99/month' : '$999/year',
                additional: billingPeriod === 'monthly' ? '$49/month' : '$499/year'
              }, `First user: ${billingPeriod === 'monthly' ? '$99/month' : '$999/year'}, Additional: ${billingPeriod === 'monthly' ? '$49/month' : '$499/year'}`)}
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <label className="text-sm font-medium text-gray-700">
                {getText('seax.pricing.omniCalculator.phone.label', 'Phone Numbers')}
              </label>
            </div>
            ...
            <div className="ml-7">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-gray-600 break-words hyphens-auto flex-1 mr-2">
                  {getText('seax.pricing.omniCalculator.phone.local', 'Local Numbers ($2/month each)')}
                </span>
            ...
            <div className="ml-7">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-gray-600 break-words hyphens-auto flex-1 mr-2">
                  {getText('seax.pricing.omniCalculator.phone.tollfree', 'Toll-Free Numbers ($3/month each)')}
                </span>
                <div className="flex items-center space-x-2 flex-shrink-0">
                  <button
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-2">
              ...
              <label className="text-sm font-medium text-gray-700">
                {getText('seax.pricing.omniCalculator.whatsapp.label', 'WhatsApp Business Numbers')}
              </label>
            </div>
            <div className="flex items-center space-x-4">
              <button
            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-3 flex items-start space-x-2">
              ...
              <p className="text-sm text-emerald-700">
                {getText('seax.pricing.omniCalculator.whatsapp.note', 'WhatsApp Business numbers are free to set up. You only pay for messages sent.')}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h4 className="text-lg font-medium text-gray-900">
              {getText('seax.pricing.omniCalculator.usageTitle', 'Monthly Usage')}
            </h4>
            
            {/* SMS */}
            <div className="space-y-2">
              <label className="text-sm text-gray-600">
                {getText('seax.pricing.omniCalculator.sms', 'SMS Messages ($0.02 each)')}
              </label>
              <input
                type="range"
                min="0"
            ...
            <div className="space-y-2">
              <label className="text-sm text-gray-600">
                {getText('seax.pricing.omniCalculator.calls', 'Call Minutes ($0.015 per minute)')}
              </label>
              <input
                type="range"
                min="0"
              ...
              <div className="flex justify-between text-sm text-gray-500">
                ...
                <span>{getText('omniCalculator.ranges.callsMax', '5,000')}</span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <label className="text-sm text-gray-600">
                {getText('seax.pricing.omniCalculator.voicemail', 'Voicemail Drops ($0.05 each)')}
              </label>
              <input
                type="range"
                min="0"
              ...
              <div className="flex justify-between text-sm text-gray-500">
                ...
                <span>{getText('omniCalculator.ranges.voicemailMax', '1,000')}</span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <label className="text-sm text-gray-600">
                {getText('seax.pricing.omniCalculator.whatsappMessages', 'WhatsApp Messages (Free for business-initiated)')}
              </label>
              <input
                type="range"
                min="0"
              ...
              <div className="flex justify-between text-sm text-gray-500">
                ...
                <span>{getText('omniCalculator.ranges.whatsappMax', '10,000')}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-xl p-6">
          <h3 className="text-xl font-semibold text-gray-900 mb-6">
            {getText('seax.pricing.omniCalculator.breakdownTitle', {
              period: billingPeriod === 'monthly' ? getText('seax.pricing.omniCalculator.billing.monthly', 'Monthly') : getText('seax.pricing.omniCalculator.billing.yearly', 'Yearly')
            }, `${billingPeriod === 'monthly' ? 'Monthly' : 'Yearly'} Cost Breakdown`)}
          </h3>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center py-2 border-b border-gray-200">
              <div>
                <span className="text-gray-700">
                  {getText('seax.pricing.omniCalculator.usersBreakdown', { count: users }, `${users} User${users > 1 ? 's' : ''}`)}
                </span>
                <p className="text-sm text-gray-500">
                  {getText('seax.pricing.omniCalculator.usersDetail', { additional: Math.max(0, users - 1) }, `1 first user + ${Math.max(0, users - 1)} additional`)}
                </p>
              </div>
            ...
            {(localNumbers > 0 || tollFreeNumbers > 0) && (
              <div className="flex justify-between items-center py-2 border-b border-gray-200">
                <div>
                  <span className="text-gray-700">
                    {getText('seax.pricing.omniCalculator.phoneBreakdown', 'Phone Numbers')}
                  </span>
                  <p className="text-sm text-gray-500">
                    {localNumbers} {getText('omniCalculator.breakdown.localPlus', 'local')} + {tollFreeNumbers} {getText('omniCalculator.breakdown.tollFreeMinus', 'toll-free')}
                  </p>
                </div>
            ...
            {whatsappNumbers > 0 && (
              <div className="flex justify-between items-center py-2 border-b border-gray-200">
                <div>
                  <span className="text-gray-700">
                    {getText('seax.pricing.omniCalculator.whatsappBreakdown', { count: whatsappNumbers }, `${whatsappNumbers} WhatsApp Number${whatsappNumbers > 1 ? 's' : ''}`)}
                  </span>
                  <p className="text-sm text-emerald-600">
                    {getText('seax.pricing.omniCalculator.whatsappFree', 'Free setup')}
                  </p>
                </div>
            ...
            {smsCount > 0 && (
              <div className="flex justify-between items-center py-2 border-b border-gray-200">
                <span className="text-gray-700">
                  {getText('seax.pricing.omniCalculator.smsBreakdown', { count: smsCount }, `${smsCount} SMS Messages`)}
                </span>
            ...
            {callMinutes > 0 && (
              <div className="flex justify-between items-center py-2 border-b border-gray-200">
                <span className="text-gray-700">
                  {getText('seax.pricing.omniCalculator.callsBreakdown', { count: callMinutes }, `${callMinutes} Call Minutes`)}
                </span>
            ...
            {voicemailDrops > 0 && (
              <div className="flex justify-between items-center py-2 border-b border-gray-200">
                <span className="text-gray-700">
                  {getText('seax.pricing.omniCalculator.voicemailBreakdown', { count: voicemailDrops }, `${voicemailDrops} Voicemail Drops`)}
                </span>
            ...
            {whatsappMessages > 0 && (
              <div className="flex justify-between items-center py-2 border-b border-gray-200">
                <div>
                  <span className="text-gray-700">
                    {getText('seax.pricing.omniCalculator.whatsappMessagesBreakdown', { count: whatsappMessages }, `${whatsappMessages} WhatsApp Messages`)}
                  </span>
                  <p className="text-sm text-emerald-600">
                    {getText('seax.pricing.omniCalculator.whatsappMessagesFree', 'Free for business-initiated')}
                  </p>
                </div>
                <span className="text-lg font-semibold text-emerald-600">$0</span>
              </div>
            ...
            <div className="flex justify-between items-center py-4 border-t-2 border-gray-300">
              <span className="text-xl font-bold text-gray-900">
                {getText('seax.pricing.omniCalculator.total', {
                  period: billingPeriod === 'monthly' ? getText('seax.pricing.omniCalculator.billing.monthly', 'Monthly') : getText('seax.pricing.omniCalculator.billing.yearly', 'Yearly')
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-green-800 font-semibold">
                    {getText('seax.pricing.omniCalculator.savings.title', { amount: savings.toLocaleString() }, `Save $${savings.toLocaleString()} per year`)}
                  </span>
                </div>
                <p className="text-sm text-green-700 mt-1">
                  {getText('seax.pricing.omniCalculator.savings.detail', 'Compared to paying monthly')}
                </p>
              </div>
            )}
          </div>
