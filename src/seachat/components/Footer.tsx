...
const Footer = () => {
  ...
  const featuresLinks = [
    { name: t('header.featuresDropdown.humanAgents'), href: `/${currentLanguage}/seachat/features/human-agents`, icon: Users },
    { name: t('header.featuresDropdown.aiAutomation'), href: `/${currentLanguage}/seachat/features/ai-automation`, icon: Bot },
    { name: t('header.featuresDropdown.advancedAI'), href: `/${currentLanguage}/seachat/features/advanced-ai`, icon: Brain },
    { name: t('header.featuresDropdown.knowledgeBase'), href: `/${currentLanguage}/seachat/features/knowledge-base`, icon: Database },
    { name: t('header.featuresDropdown.voiceAgents'), href: `/${currentLanguage}/seachat/features/voice-agents`, icon: Phone },
    { name: t('header.featuresDropdown.analytics'), href: `/${currentLanguage}/seachat/features/analytics`, icon: BarChart3 },
    { name: t('header.featuresDropdown.omnichannel'), href: `/${currentLanguage}/seachat/features/omnichannel`, icon: MessageSquare },
    { name: t('header.featuresDropdown.api'), href: `/${currentLanguage}/seachat/features/api`, icon: Code }
  ];

  const integrationsLinks = [
    { name: t('header.integrationsDropdown.websites'), href: `/${currentLanguage}/seachat/integrations/websites`, icon: Globe },
    { name: t('header.integrationsDropdown.crm'), href: `/${currentLanguage}/seachat/integrations/crm`, icon: Users },
    { name: t('header.integrationsDropdown.ecommerce'), href: `/${currentLanguage}/seachat/integrations/ecommerce`, icon: ShoppingCart },
    { name: t('header.integrationsDropdown.socialMedia'), href: `/${currentLanguage}/seachat/integrations/social-media`, icon: MessageSquare },
    { name: t('header.integrationsDropdown.communication'), href: `/${currentLanguage}/seachat/integrations/communication`, icon: Phone },
    { name: t('header.integrationsDropdown.marketing'), href: `/${currentLanguage}/seachat/integrations/marketing`, icon: BarChart3 },
    { name: t('header.integrationsDropdown.calendar'), href: `/${currentLanguage}/seachat/integrations/calendar`, icon: Settings },
    { name: t('header.integrationsDropdown.api'), href: `/${currentLanguage}/seachat/integrations/api`, icon: Code }
  ];

  const solutionsLinks = [
    { name: t('header.solutionsDropdown.ecommerce'), href: `/${currentLanguage}/seachat/solutions/ecommerce`, icon: ShoppingCart },
    { name: t('header.solutionsDropdown.healthcare'), href: `/${currentLanguage}/seachat/solutions/healthcare`, icon: Heart },
    { name: t('header.solutionsDropdown.fintech'), href: `/${currentLanguage}/seachat/solutions/fintech`, icon: DollarSign },
    { name: t('header.solutionsDropdown.education'), href: `/${currentLanguage}/seachat/solutions/education`, icon: GraduationCap },
    { name: t('header.solutionsDropdown.realEstate'), href: `/${currentLanguage}/seachat/solutions/real-estate`, icon: Building2 },
    { name: t('header.solutionsDropdown.travel'), href: `/${currentLanguage}/seachat/solutions/travel`, icon: MapPin },
    { name: t('header.solutionsDropdown.saas'), href: `/${currentLanguage}/seachat/solutions/saas`, icon: Monitor },
    { name: t('header.solutionsDropdown.smallBusiness'), href: `/${currentLanguage}/seachat/solutions/small-business`, icon: Briefcase }
  ];
  ...
  const companyLinks = [
    ...
    { name: t('header.compareUs', { ns: 'common' }), href: `/${currentLanguage}/compare-us-overview`, icon: BarChart3 },
    { name: t('footer.company.productWiki'), href: 'https://wiki.seasalt.ai/seachat', icon: Book },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-2 sm:gap-3 lg:gap-4">
          ...
          <div>
            ...
            <h3 className="hidden lg:block text-lg font-semibold mb-6">{t('header.features')}</h3>
          ...
          <div>
            {/* Desktop: Regular heading */}
            <h3 className="hidden lg:block text-lg font-semibold mb-6">{t('header.integrations')}</h3>
          ...
          <div>
            {/* Desktop: Regular heading */}
            <h3 className="hidden lg:block text-lg font-semibold mb-6">{t('header.solutions')}</h3>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 text-xs sm:text-sm text-gray-300">
              <span className="flex items-center">
                ...
                {t('footer.stats.messagesDaily')}
              </span>
              <span className="flex items-center">
                <Users className="w-4 h-4 mr-1" />
                {t('footer.stats.activeUsers')}
              </span>
              <span className="flex items-center">
