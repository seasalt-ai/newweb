...
exports.COMMON_SCHEMA_TYPES = exports.SCHEMA_CONTEXT = exports.SCHEMA_AVAILABILITY = exports.WEBSITE_INFO = exports.PRODUCTS_INFO = exports.LOCALIZED_PRODUCT_DESCRIPTIONS = exports.ORGANIZATION_INFO = exports.SCHEMA_IDS = void 0;
exports.getLocalizedPricingTiers = getLocalizedPricingTiers;
exports.getLocalizedProductInfo = getLocalizedProductInfo;
exports.getProductPricingTiers = getProductPricingTiers;
exports.getPopularPricingTier = getPopularPricingTier;
exports.getLocalizedProductDescription = getLocalizedProductDescription;
...
exports.ORGANIZATION_INFO = {
    ...
    contactPoint: {
        ...
        availableLanguage: languages_1.SUPPORTED_LANGUAGES.map(lang => languages_1.LANGUAGE_REGION_MAP[lang]?.language || lang)
    },
    aggregateRating: {
        ratingValue: 4.8,
        bestRating: 5.0,
    ...
    availableLanguage: [...languages_1.SUPPORTED_LANGUAGES]
};
// =============================================================================
 ...
 */
exports.LOCALIZED_PRODUCT_DESCRIPTIONS = {
    seachat: {
 ...
 */
function getLocalizedPricingTiers(productKey, language = 'en') {
 ...
 */
function getPricingTierNames(productKey, language) {
    const names = {
        seachat: {
 ...
 */
function getPricingTierDescriptions(productKey, language) {
    const descriptions = {
        seachat: {
            'en': [
 ...
 */
function getPricingTierFeatures(productKey, language) {
    const features = {
        seachat: {
            'en': [
 ...
 */
function getLocalizedProductInfo(productKey, language = 'en', tierIndex = 0) {
    ...
    const localizedDescription = exports.LOCALIZED_PRODUCT_DESCRIPTIONS[productKey][language] || exports.LOCALIZED_PRODUCT_DESCRIPTIONS[productKey]['en'];
 ...
 */
function getProductPricingTiers(productKey) {
 ...
 */
function getPopularPricingTier(productKey) {
 ...
 */
function getLocalizedFeatures(productKey, language) {
    const features = {
        seachat: {
            'en': [
 ...
 * Get localized offer description
 */
function getLocalizedOfferDescription(productKey, language, tier) {
    const descriptions = {
        seachat: {
...
exports.WEBSITE_INFO = {
    name: 'Seasalt.ai',
    url: 'https://seasalt.ai',
    description: 'Leading AI conversation intelligence platform offering omnichannel customer communication solutions for businesses of all sizes.',
    inLanguage: languages_1.SUPPORTED_LANGUAGES.map(lang => languages_1.LANGUAGE_REGION_MAP[lang]?.primaryLocale.replace('_', '-') || lang),
    potentialAction: {
        '@type': 'SearchAction',
        target: {
            '@type': 'EntryPoint',
 ...
 */
function getLocalizedProductDescription(productKey, language) {
    const localizedDesc = exports.LOCALIZED_PRODUCT_DESCRIPTIONS[productKey]?.[language];
    if (localizedDesc) {
        return localizedDesc;
    }
    // Fallback to English description
    const englishDesc = exports.LOCALIZED_PRODUCT_DESCRIPTIONS[productKey]?.['en'];
    if (englishDesc) {
        return englishDesc;
    }
    // Final fallback to the basic product info description
    return exports.PRODUCTS_INFO[productKey]?.description || '';
}
/**
 ...
 */
function getProductInfo(productKey, language) {
    const baseInfo = exports.PRODUCTS_INFO[productKey];
    if (!baseInfo) {
