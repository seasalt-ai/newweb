...
const LeadGeneration = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHelmet 
        title="SeaX LeadGeneration - Scale Your Business"
        description="SeaX LeadGeneration solution helps businesses scale their communication and achieve better results."
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-100 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Transform your business communication with our comprehensive LeadGeneration solution.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              Everything you need for successful LeadGeneration
            </p>
          </div>
      ...
      <div className="py-20 bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Ready to Transform Your LeadGeneration?
          </h2>
