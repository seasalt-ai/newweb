...
const AppointmentReminders = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHelmet 
        title="SeaX AppointmentReminders - Scale Your Business"
        description="SeaX AppointmentReminders solution helps businesses scale their communication and achieve better results."
