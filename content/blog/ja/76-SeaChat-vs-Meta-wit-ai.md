...
チャットボットの世界は急速に進化しています。Meta/Facebookの [wit.ai](http://wit.ai) は音声アプリの入門として役立ちましたが、[SeaChat](https://chat.seasalt.ai/?utm_source=blog) のようなLLM技術が会話型AIの新時代を切り開いています。wit.aiの限界を超える時が来ました。
