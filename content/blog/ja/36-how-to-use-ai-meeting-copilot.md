...
1. SeaMeetブラウザ拡張機能をインストール
2. Google MeetまたはTeams会議に通常通り参加
3. SeaMeetは自動的に会話の記録と分析を開始します

プロのヒント：過去の会議から情報をすばやく見つけるには、「履歴検索」機能を使用してください。