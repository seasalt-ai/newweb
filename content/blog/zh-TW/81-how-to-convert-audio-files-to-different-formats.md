...
在我們的特定用例中，我們有一個名為 [SeaMeet](https://meet.seasalt.ai/?utm_source=blog) 的對話智能軟體，它接受各種音訊格式的音訊檔案或串流（例如 Google Meet），並將對話從語音轉換為文字。因此，我們必須將各種格式的音訊即時轉換為與我們的語音識別引擎相容的格式。
