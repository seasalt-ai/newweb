...
meta_description: با اصول Next.js، یک فریم‌ورک React برای ساخت برنامه‌های وب آماده
  تولید با رندرینگ سمت سرور و تولید سایت استاتیک آشنا شوید.
metatitle: 'شروع کار با Next.js: راهنمای مبتدیان'
