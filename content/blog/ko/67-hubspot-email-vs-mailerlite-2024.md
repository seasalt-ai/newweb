...
10분 안에 AI 채팅 에이전트를 구축하고 시작하세요. 다국어 지원. 라이브 에이전트 전송. 웹챗, SMS, Line, CRM, Shopify, 캘린더, Twilio, ZenDesk 및 전화 통화와 통합됩니다. 자세한 내용은 [seachat@seasalt.ai](mailto:help@seameet.ai)로 이메일을 보내거나 [데모를 예약](https://meetings.hubspot.com/seasalt-ai/seasalt-meeting)하세요.
