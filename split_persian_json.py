#!/usr/bin/env python3
"""Split Persian JSON file into five equal parts for translation processing."""
import json
import math
import os
...
OUTPUT_PREFIX = "public/locales/fa_part"
TOTAL_PARTS = 5
...
def split_persian_json() -> None:
    """Split the Persian JSON into five equal parts."""
    # Load the Persian JSON file
    with open(INPUT_FILE, 'r', encoding='utf-8') as f:
        fa_data = json.load(f)
    
    # Get all key-value pairs
    all_items = get_nested_items(fa_data)
    ...
    for part_num in range(1, TOTAL_PARTS + 1):
        ...
        # Write to file with Persian text support
...
if __name__ == "__main__":
    ...
    split_persian_json()
    print("Persian JSON splitting completed successfully!")
