...
description: 최신 릴리스를 통해 SeaVoice Discord Bot은 AI 생성 텍스트 변환 기능이 있는 다운로드 가능한 음성 채널 녹음을
  제공하는 플랫폼 최초의 봇입니다.
...
image:
  ...
  alt: 'SeaVoice STT/TTS Discord Bot: AI 텍스트 변환 기능이 있는 다운로드 가능한 음성 녹음을 제공하는 최초의 봇'
tags:
- SeaVoice
- Discord
lang: ko
