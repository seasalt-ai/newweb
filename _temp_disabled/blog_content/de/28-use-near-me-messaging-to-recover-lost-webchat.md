---
title: 'Benutzer hat den Webchat verlassen: Verwenden Sie Near Me Messaging, um ihm
  eine Nachricht zu senden!'
description: 'Near Me Messaging löst ein Problem des Webchats: Nehmen Sie auch *nachdem*
  der Benutzer das Gespräch verlassen hat, wieder Kontakt mit ihm auf.'
...
image:
  ...
  alt: 'Benutzer hat den Webchat verlassen: Verwenden Sie Near Me Messaging, um ihm
    eine Nachricht zu senden!'
tags:
- NearMe
lang: de
