...
description: Xuchen Yao partage son expérience récente avec le service client United
  Airlines pendant les retards et annulations de vols, et propose des solutions pour
  relever les défis de l'extension dynamique du support client pendant les pics de
  trafic.
...
image:
  ...
  alt: 'Service client United Airlines : le bon, le mauvais et le laid'
tags:
- SeaX
lang: fr
draft: false
