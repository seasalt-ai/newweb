---
title: 'Discord (3/3): Discord et Twilio Flex: Amener le Centre de Contact Flex en
  Territoire Inexploré'
description: Dans ce blog, nous démontrons comment Seasalt.ai intègre un centre de
  contact complet dans un serveur Discord.
...
image:
  ...
  alt: 'Discord (3/3): Discord et Twilio Flex: Amener le Centre de Contact Flex en
    Territoire Inexploré'
tags:
- SeaX
- Discord
...
Pour une démo personnelle, ou pour apprendre comment Seasalt.ai peut vous aider à répondre à vos besoins spécifiques en affaires, veuillez remplir notre formulaire ["Réserver une Démo"](https://meetings.hubspot.com/seasalt-ai/seasalt-meeting). Pour plus d'informations sur l'intégration Flex/Discord ou pour nous contacter, visitez la [Liste des Partenaires Twilio de Seasalt.ai](https://showcase.twilio.com/partner-listing/a8E8Z000000PDCQUA4).