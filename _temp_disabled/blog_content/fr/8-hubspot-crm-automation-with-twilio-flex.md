---
title: 'Automatisation du centre de contact par IA : collaboration des agents virtuels
  avec le CRM'
description: Dans ce blog, nous explorons l'intégration d'un CRM comme HubSpot dans
  le centre de contact Seax, vous offrant un accès direct à toutes vos informations
  et outils.
