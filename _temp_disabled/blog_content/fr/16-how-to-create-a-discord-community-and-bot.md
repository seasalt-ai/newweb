---
title: 'Discord (2/3) : Comment créer une communauté et un bot Discord pour votre
  marque'
description: Dans ce blog, nous vous guiderons dans la création d'un serveur pour
  votre marque et la connexion d'un bot, qui peut automatiser la modération, le rapport
  de bugs, les annonces, etc.
...
image:
  ...
  alt: 'Discord (2/3) : Comment créer une communauté et un bot Discord pour votre
    marque'
tags:
- SeaX
- Discord
