---
title: 'SeaVoice STT/TTS Discord Bot: Первый, кто предоставляет загружаемые голосовые
  записи с AI-транскрипциями'
description: С последним выпуском, SeaVoice Discord Bot является первым на платформе,
  который предлагает загружаемые записи голосовых каналов с транскрипциями, сгенерированными
  ИИ.
...
image:
  ...
  alt: 'SeaVoice STT/TTS Discord Bot: Первый, кто предоставляет загружаемые голосовые
    записи с AI-транскрипциями'
tags:
- SeaVoice
- Discord
