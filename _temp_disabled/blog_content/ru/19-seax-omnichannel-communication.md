---
title: Привлекайте клиентов с любого канала в одно место с помощью омниканальной коммуникации
  SeaX
description: В этом блоге мы расскажем об одном из омниканальных средств связи SeaX,
  которое позволяет отображать сообщения пользователей с любого канала на платформе
  SeaX.
